...
/*macro "specify [s]" { 
  getCursorLoc(x, y, z, flags)
  //run("Specify...", "width=400 height=400 x=2500 y=2500 slice=1 constrain"); 
  run("Specify...", "width=800 height=800 x=" + x-400 + " y=" + y-400 + " slice=1 constrain");
} 
*/
macro "specify [s]" { 
  getCursorLoc(x, y, z, flags)
  //run("Specify...", "width=400 height=400 x=2500 y=2500 slice=1 constrain"); 
  run("Specify...", "width=400 height=400 x=" + x-200 + " y=" + y-200 + " slice=1 constrain");
} 
